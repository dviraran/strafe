...
from
(select person_id, min(condition_start_date) + 365 as ckd2_time
...
where  ckd2.ckd2_time is not null and
      ((ckd4.ckd4_time is null and obs.end_date>ckd2.ckd2_time) or (ckd2.ckd2_time<ckd4.ckd4_time and ckd4.ckd4_time is not null) ) and v.num_visits>5;
